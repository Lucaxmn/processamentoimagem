namespace Tecnica06
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            // ===== FORM =====
            Text = "Técnica 06 - Inverter Imagem (Esquerda → Direita)";
            ...
            // ===== TÍTULO =====
            lblTitulo.Text = "Espelhamento horizontal: pixel [x] vai para [largura - 1 - x]";
            ...
            picOriginal.Size = new Size(420, 390);
            ...
            lblOriginal.Location = new Point(20, 497);
            lblOriginal.Size = new Size(420, 20);
            lblOriginal.ForeColor = Color.DimGray;

            // ===== SETA =====
            lblSeta.Text = "←→";
            lblSeta.Font = new Font("Segoe UI", 22f, FontStyle.Bold);
            lblSeta.ForeColor = Color.FromArgb(0, 120, 215);
            lblSeta.Location = new Point(452, 280);
            lblSeta.Size = new Size(60, 40);
            ...
            picInvertida.Size = new Size(420, 390);
            ...
            lblInvertida.Text = "Imagem invertida horizontalmente";
            lblInvertida.Location = new Point(520, 497);
